...
The dataset and code used in this analysis are available on [GitHub](https://github.com/yourusername/repository_name).

---

This Quarto document walks through obtaining the ACS data, using the ratio estimator approach, and comparing estimates to actual counts. Ensure you have saved the ACS dataset correctly and adjust paths as needed. Save this file as `.qmd`, render it to produce a PDF, and push the project to your GitHub repository.